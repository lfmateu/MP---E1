...
def cadastrar_patinador():
    ...
    inserir_patinador(Patinador('Amber Glenn', 'Acrobático', 'Estados Unidos'))
    inserir_patinador(Patinador('Madison Chock', 'Icedance', 'Estados Unidos'))
    inserir_patinador(Patinador('Evan Bates', 'Icedance', 'Estados Unidos'))
    inserir_patinador(Patinador('Nathan Chen', 'Acrobático', 'Estados Unidos'))
    inserir_patinador(Patinador('Marissa Bell', 'Clássico', 'Estados Unidos'))
    inserir_patinador(Patinador('Mirai Nagasu', 'Expressivo', 'Estados Unidos'))
    inserir_patinador(Patinador('Yuma Kagiyama', 'Clássico', 'Japão'))
    inserir_patinador(Patinador('Shoma Uno', 'Contemporâneo', 'Japão'))
    inserir_patinador(Patinador('Kaori Sakamoto', 'Clássico', 'Japão'))
...
if __name__ == '__main__':
    ...
    imprimir_objetos(cabeçalho='Patinadores: nome, estilo, país', objetos=get_patinadores())
    imprimir_objetos(cabeçalho='Olimpíadas: ID, nome, ano e internacional', objetos=get_olimpiadas())
